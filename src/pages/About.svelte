...
<section class="terminal-opening" bind:this={terminalSection} in:fly="{{ y: 0, duration: 1000 }}" out:fly="{{ y: -1000, duration: 1000 }}">
    ...
    {:else if currentStep === 2}
        <TextScroll startDelay={200} audioPlay={$audioEnabled} typingSpeed={40} text="Hello! I'm Dylan Todd, I'm currently a 3rd year student at Laurentian University, pursuing a bachelor's degree in Computer Science."/><br>
